...
namespace FileStreamApp
{
    ...
    public class UpFileSingleTest
    {
        ...
        public void Upload()
        {
            ...
            FileInfo info = new FileInfo(@"G:\upload\lame-3.100.tar.gz");
            //取得文件总长度
            ...
            for (int i = 0; i < divide + 1; i++)
            {
                ...
                //上传该段数据
                UpLoadFileFromLocal(@"G:\upload\lame-3.100.tar.gz", @"G:\upload\lame-3.1002.tar.gz", startPosition, i == divide ? divide : totalCount);
            }
        }
